...
class BaseCommand {
    ...
    get embed() {
        return class extends MessageEmbed {
            constructor(options) {
                ...
                this.footer = {
                    text: "BTE Germany",
                    iconURL: "https://cdn.discordapp.com/icons/692825222373703772/a_e643511c769fd27a0f361d01c23f2cee.gif?size=1024"
                }
            }
        }
    }
	...
	async initialize(guildId) {
        ...
        if(this.config.userAvailable) this.config.permissions.push({
            id: this.client.config.roles.rules, 
            type: "ROLE",
            permission: true
        });
